...
const localizedApiErrors: Record<string, string> = {
  ...
  SESSIOND_DRAINING: "Session Daemon 正在为服务或 Package 变更排空，暂不接受新会话",
  ACTIVE_WORKERS_BLOCK_SERVICE_CHANGE: "仍有活动 Worker，默认拒绝停止、重启或卸载服务",
  ACTIVE_WORKERS_BLOCK_PI_CHANGE: "仍有活动 Worker，默认拒绝修改 Pi Packages",
  PI_VERSION_UNSUPPORTED: "当前 Pi 版本或 RPC 能力不满足兼容基线",
  EXTENSION_UI_NOT_PENDING: "扩展交互已结束或已由其他客户端响应",
