...
import { formatDate, isAbortError } from "./api";
import { Dialog, ErrorBanner, Loading, StatusDot } from "./components";
import { useNavigate } from "./router";
import { fetchAllSessions } from "./useSessionList";
...
const pageCommands: CommandPaletteItem[] = [
  ...
  },
  {
    id: "pi",
    label: "打开 Pi 管理",
    description: "查看运行状态、模型、Skills 和 Packages",
    keywords: "model runtime package skill 模型 运行时 插件",
    to: "/pi",
    icon: Bot
  },
  {
...
export function CommandPalette({
  ...
  useEffect(() => {
    ...
    void fetchAllSessions(controller.signal)
      .then(setSessions)
      .catch((reason) => {
