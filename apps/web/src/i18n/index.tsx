...
const englishMessages: Record<string, string> = {
  ...
  "确定删除会话“{{name}}”？这会从会话列表中移除，但不会删除原始 Pi 记录。":
    "Delete session “{{name}}”? It will be removed from the session list, but the original Pi record will be kept.",
  ...
  "确定删除会话“{{name}}”？原始 Pi 记录仍会保留。":
    "Delete session “{{name}}”? The original Pi record will be kept.",
