...
const mduiColorTokenMappings = [
  ["--mdui-color-primary", "--md-sys-color-primary"],
  ["--mdui-color-primary-container", "--md-sys-color-primary-container"],
  ["--mdui-color-on-primary", "--md-sys-color-on-primary"],
  [
    "--mdui-color-on-primary-container",
    "--md-sys-color-on-primary-container"
  ],
  ["--mdui-color-inverse-primary", "--md-sys-color-inverse-primary"],
  ["--mdui-color-secondary", "--md-sys-color-secondary"],
  [
    "--mdui-color-secondary-container",
    "--md-sys-color-secondary-container"
  ],
  ["--mdui-color-on-secondary", "--md-sys-color-on-secondary"],
  [
    "--mdui-color-on-secondary-container",
    "--md-sys-color-on-secondary-container"
  ],
  ["--mdui-color-tertiary", "--md-sys-color-tertiary"],
  ["--mdui-color-tertiary-container", "--md-sys-color-tertiary-container"],
  ["--mdui-color-on-tertiary", "--md-sys-color-on-tertiary"],
  [
    "--mdui-color-on-tertiary-container",
    "--md-sys-color-on-tertiary-container"
  ],
  ["--mdui-color-surface", "--md-sys-color-surface"],
  ["--mdui-color-surface-dim", "--md-sys-color-surface-dim"],
  ["--mdui-color-surface-bright", "--md-sys-color-surface-bright"],
  [
  ...
  ["--mdui-color-surface-variant", "--md-sys-color-surface-variant"],
  ["--mdui-color-on-surface", "--md-sys-color-on-surface"],
  [
    "--mdui-color-on-surface-variant",
    "--md-sys-color-on-surface-variant"
  ],
  ["--mdui-color-inverse-surface", "--md-sys-color-inverse-surface"],
  [
    "--mdui-color-inverse-on-surface",
    "--md-sys-color-inverse-on-surface"
  ],
  ["--mdui-color-background", "--md-sys-color-background"],
  ["--mdui-color-on-background", "--md-sys-color-on-background"],
  ["--mdui-color-error", "--md-sys-color-error"],
  ["--mdui-color-error-container", "--md-sys-color-error-container"],
  ["--mdui-color-on-error", "--md-sys-color-on-error"],
  [
    "--mdui-color-on-error-container",
    "--md-sys-color-on-error-container"
  ],
  ["--mdui-color-outline", "--md-sys-color-outline"],
  ["--mdui-color-outline-variant", "--md-sys-color-outline-variant"],
  ["--mdui-color-shadow", "--md-sys-color-shadow"],
  ["--mdui-color-scrim", "--md-sys-color-scrim"],
  ["--mdui-color-surface-tint-color", "--md-sys-color-surface-tint"]
] as const;

const mduiShapeTokenMappings = [
  ["--mdui-shape-corner-none", "--md-sys-shape-corner-none"],
  [
    "--mdui-shape-corner-extra-small",
    "--md-sys-shape-corner-extra-small"
  ],
  ["--mdui-shape-corner-small", "--md-sys-shape-corner-small"],
  ["--mdui-shape-corner-medium", "--md-sys-shape-corner-medium"],
  ["--mdui-shape-corner-large", "--md-sys-shape-corner-large"],
  [
    "--mdui-shape-corner-extra-large",
    "--md-sys-shape-corner-extra-large"
  ],
  ["--mdui-shape-corner-full", "--md-sys-shape-corner-full"]
] as const;

/**
 * Theme packages predate MDUI and expose regular CSS colors rather than the
 * comma-separated RGB channels consumed inside MDUI's shadow roots. This map
 * keeps their semantic palette useful when the four-color override is off.
 *
 * Custom theme CSS still owns the light DOM. Only documented theme tokens are
 * translated here; arbitrary selectors cannot be forwarded through a shadow
 * boundary.
 */
const themePackMduiColorTokenMappings = [
  ["--mdui-color-primary", "--lime"],
  ["--mdui-color-on-primary", "--lime-ink"],
  ["--mdui-color-primary-container", "--panel-3"],
  ["--mdui-color-on-primary-container", "--text"],
  ["--mdui-color-inverse-primary", "--blue"],
  ["--mdui-color-secondary", "--violet"],
  ["--mdui-color-on-secondary", "--bg"],
  ["--mdui-color-secondary-container", "--panel-2"],
  ["--mdui-color-on-secondary-container", "--text"],
  ["--mdui-color-tertiary", "--teal"],
  ["--mdui-color-on-tertiary", "--bg"],
  ["--mdui-color-tertiary-container", "--panel-3"],
  ["--mdui-color-on-tertiary-container", "--text"],
  ["--mdui-color-surface", "--bg"],
  ["--mdui-color-surface-dim", "--bg"],
  ["--mdui-color-surface-bright", "--bg-raised"],
  ["--mdui-color-surface-container-lowest", "--bg-raised"],
  ["--mdui-color-surface-container-low", "--panel"],
  ["--mdui-color-surface-container", "--panel-2"],
  ["--mdui-color-surface-container-high", "--panel-3"],
  ["--mdui-color-surface-container-highest", "--panel-3"],
  ["--mdui-color-surface-variant", "--panel-2"],
  ["--mdui-color-on-surface", "--text"],
  ["--mdui-color-on-surface-variant", "--text-soft"],
  ["--mdui-color-inverse-surface", "--text"],
  ["--mdui-color-inverse-on-surface", "--bg"],
  ["--mdui-color-background", "--bg"],
  ["--mdui-color-on-background", "--text"],
  ["--mdui-color-error", "--red"],
  ["--mdui-color-error-container", "--panel-3"],
  ["--mdui-color-on-error", "--bg"],
  ["--mdui-color-on-error-container", "--text"],
  ["--mdui-color-outline", "--line"],
  ["--mdui-color-outline-variant", "--line-soft"],
  ["--mdui-color-surface-tint-color", "--lime"]
] as const;

const themePackMduiShapeTokenMappings = [
  ["--mdui-shape-corner-extra-small", "--radius-sm"],
  ["--mdui-shape-corner-small", "--radius-sm"],
  ["--mdui-shape-corner-medium", "--radius-sm"],
  ["--mdui-shape-corner-large", "--radius"],
  ["--mdui-shape-corner-extra-large", "--radius"]
] as const;

/**
 * MDUI consumes comma-separated RGB channels because its component styles use
 * `rgb(var(--mdui-color-*)))`. Shape values remain regular CSS lengths.
 */
export const mduiThemeTokenNames: readonly string[] = [
  ...mduiColorTokenMappings.map(([name]) => name),
  ...mduiShapeTokenMappings.map(([name]) => name)
];
...
/**
 * Adapts the already-computed four-seed MD3 scheme for MDUI. This deliberately
 * does not call MDUI's single-seed `setColorScheme`: doing so would collapse
 * the independently editable roles and replace the neutral-derived surfaces.
 */
export function createMduiThemeTokens(
  materialTokens: Readonly<Record<string, string>>
): Record<string, string> {
  const tokens: Record<string, string> = {};
  for (const [mduiName, materialName] of mduiColorTokenMappings) {
    tokens[mduiName] = toMduiRgbTriplet(
      requiredToken(materialTokens, materialName)
    );
  }
  return tokens;
}
...
/**
 * Creates a best-effort MDUI palette from a legacy theme package.
 *
 * Hex and rgb()/rgba() colors are losslessly converted. More complex CSS
 * expressions (for example color-mix() or var()) are intentionally skipped,
 * allowing MDUI's built-in fallback for that individual role instead of
 * emitting an invalid nested rgb() value.
 */
export function createThemePackMduiTokens(
  themeTokens: Readonly<Record<string, string>>
): Record<string, string> {
  const tokens: Record<string, string> = {};
  for (const [mduiName, themeName] of themePackMduiColorTokenMappings) {
    const value = themeTokens[themeName];
    const rgb = value ? cssColorToMduiRgbTriplet(value) : null;
    if (rgb) tokens[mduiName] = rgb;
  }

  // MDUI expects these two roles even though legacy themes never exposed them.
  tokens["--mdui-color-shadow"] = "0, 0, 0";
  tokens["--mdui-color-scrim"] = "0, 0, 0";

  for (const [mduiName, themeName] of themePackMduiShapeTokenMappings) {
    const value = themeTokens[themeName]?.trim();
    if (value) tokens[mduiName] = value;
  }
  tokens["--mdui-shape-corner-none"] = "0px";
  tokens["--mdui-shape-corner-full"] = "999px";
  return tokens;
}

export function applyThemePackMduiTokensToRoot(
  root: HTMLElement,
  themeTokens: Readonly<Record<string, string>>
): Record<string, string> {
  for (const token of mduiThemeTokenNames) {
    root.style.removeProperty(token);
  }
  const tokens = createThemePackMduiTokens(themeTokens);
...
export function applyMaterialThemeSettingsToRoot(
  ...
  const mduiTokens = createMduiThemeTokens(materialTokens);
...
function clearMaterialColorOverrides(root: HTMLElement): void {
  ...
  for (const [token] of mduiColorTokenMappings) {
    root.style.removeProperty(token);
  }
  for (const token of legacyMaterialThemeTokenNames) {
    root.style.removeProperty(token);
...
function toMduiRgbTriplet(hex: string): string {
  if (!/^#[\dA-F]{6}$/i.test(hex)) {
    throw new Error(`Invalid Material color token: ${hex}`);
  }
  return hexToRgb(hex)
...
function cssColorToMduiRgbTriplet(value: string): string | null {
  const trimmed = value.trim();
  ...
  const bytes = channels.map((channel) => {
    ...
    const number = Number.parseFloat(
      percentage ? channel.slice(0, -1) : channel
    );
    if (!Number.isFinite(number)) return null;
    const byte = percentage ? (number / 100) * 255 : number;
    return Math.round(Math.min(255, Math.max(0, byte)));
  });
  return bytes.every((byte) => byte !== null) ? bytes.join(", ") : null;
}
